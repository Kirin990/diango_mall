...
SECRET_KEY = 'd=@*ph2uxmq(278%ka10#ffum#dz86_atbfvc753rqm@8$3n%x'
...
INSTALLED_APPS = [
    ...
    'ckeditor',
    # 'ckeditor_uploader',
    # django xadmin Backstage management
    'xadmin',
    'crispy_forms',
    'reversion',
    ...
    'mine.apps.MineConfig',   # Personal module
]
